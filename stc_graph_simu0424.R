#Calculation
#source("/Users/dokada/Dropbox/analysis/2022.5/stc_graph_simu0424.R") #Run in 2024.5.4
out_path <- "/Users/dokada/Desktop/work/stc_graph_simu0424/"
...
for(i in 1:n_pats){
    ...
    for(j2 in 1:length(all_sel_can)){
        for(j in 1:length(tmp2_can)){
            ...
            qqman::qq(as.numeric(pvals_mat_sub), main = paste0(tmp2, ".", tmp_as))
            dev.off()
